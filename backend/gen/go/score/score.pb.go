...
var file_score_proto_depIdxs = []int32{
	...
	0, // 3: score.ScoreService.UploadScore:input_type -> score.UploadScoreRequest
	4, // 4: score.ScoreService.TrimScore:input_type -> score.TrimScoreRequest
	1, // 5: score.ScoreService.UploadScore:output_type -> score.UploadScoreResponse
	5, // 6: score.ScoreService.TrimScore:output_type -> score.TrimScoreResponse
